...
export declare namespace BadgerTreeV2 {
  export type MerkleDataStruct = {
    root: BytesLike;
    contentHash: BytesLike;
    timestamp: BigNumberish;
    publishBlock: BigNumberish;
    startBlock: BigNumberish;
    endBlock: BigNumberish;
  };

  export type MerkleDataStructOutput = [
    string,
    string,
    BigNumber,
    BigNumber,
...
export interface BadgerTreeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "lastProposeEndBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lastProposeStartBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "lastPublishEndBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lastPublishStartBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type InsufficientFundsForRootEvent = TypedEvent<
  [string],
  { root: string }
>;

export type InsufficientFundsForRootEventFilter =
  TypedEventFilter<InsufficientFundsForRootEvent>;
...
export interface BadgerTree extends BaseContract {
  ...
  functions: {
    ...
    getCurrentMerkleData(
      overrides?: CallOverrides
    ): Promise<[BadgerTreeV2.MerkleDataStructOutput]>;
  ...
  filters: {
    ...
    "InsufficientFundsForRoot(bytes32)"(
      root?: BytesLike | null
    ): InsufficientFundsForRootEventFilter;
