...
export interface VaultInterface extends utils.Interface {
  ...
  functions: {
    ...
    'patchBalances()': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'patchBalances',
    values?: undefined,
  ): string;
...
export type FullPricePerShareUpdatedEventFilter =
  TypedEventFilter<FullPricePerShareUpdatedEvent>;
...
export interface Vault extends BaseContract {
  ...
  callStatic: {
    ...
    patchBalances(overrides?: CallOverrides): Promise<void>;
