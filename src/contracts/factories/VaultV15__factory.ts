...
import type { VaultV15, VaultV15Interface } from "../VaultV15";
...
export class VaultV15__factory {
  static readonly abi = _abi;
  static createInterface(): VaultV15Interface {
    return new utils.Interface(_abi) as VaultV15Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VaultV15 {
    return new Contract(address, _abi, signerOrProvider) as VaultV15;
  }
}
