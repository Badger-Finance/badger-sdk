...
const _abi = [
  ...
  {
    inputs: [],
    name: "crvCvxCrvSlippageToleranceBps",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract CrvDepositor",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    name: "setCrvCvxCrvSlippageToleranceBps",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
