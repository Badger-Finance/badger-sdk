...
class EthereumConfig extends network_config_1.NetworkConfig {
    constructor() {
        super('Ethereum', network_enum_1.Network.Ethereum, 1, tokens, setts);
    }
}
exports.EthereumConfig = EthereumConfig;
const tokens = (0, network_utils_1.checksumEntries)({
    // eth tokens
...
const setts = (0, network_utils_1.checksumEntries)({
